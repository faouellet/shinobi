...
struct Edge {
  ...
  /// Expand all variables in a command and return it as a std::string.
  /// If incl_rsp_file is enabled, the std::string will also contain the
...
struct DependencyScan {
  ...
  /// Recompute whether any output of the edge is dirty, if so std::sets
